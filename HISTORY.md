...
| 2026-06-24 | 5.6.3 | Updated test case: perf-base-instantiate, new test cases: bitset, date-time. |
...
| | | New test cases: leibniz-double and leibniz-big-decimal. |
...
| 2026-02-15 | 5.4.35 | New test case: crypto-G-dh-1. |
...
| 2026-01-24 | 5.4.25 | New test case: function-synchronized-multiframe. |
| 2026-01-23 | 5.4.24 | New test cases: function-synchronized-basic, function-synchronized-static, function-synchronized-iface, function-synchronized-caught, two-pass-tokenize. |
...
| | | Stop using INVOKEDYNAMIC in interface-10-Invokeinterface. |
...
| | | Print some stack traces: |
| | | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ex-catch-assertion-error, ex-catch-called-func-parseint, |
| | | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ex-catch-multi-frame, ex-catch-null-ptr, ex-catch-plus-jj, ex-catch-user-ex. |
...
| 2025-12-04 | 5.3.3 | New test case: threading-16 (16 simultaneous threads). |
...
| 2025-11-28 | 5.2.11 | Added nine test cases of interface resolution (by @platypusguy) |
...
| | | Dropped coverage of enumerate in test case threading-2
...
| 2025-10-19 | 5.1.0 | New command-line option: -u. This allows the user to supply additional options when -x is specified
| 2025-10-11 | 5.0.14 | New test case: threading-2
| 2025-10-08 | 5.0.13 | Test case http-client-server: get rid of thread pool; implement qualitative testing
| | | New test case: cached-thread-pool
...
| | | Converted test cases through io_outputstreamwriter to HELPERS
| | | Converted test cases through JACOBIN-0760-submethod to HELPERS
