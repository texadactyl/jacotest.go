...
public class main {
    ...
    public static void main(String[] args) {
        ...
        // ------------------------------------------------------------
        // Drive-relative paths (CRITICAL DIFFERENCE)
        // ------------------------------------------------------------
        Path p2 = Paths.get("C:");
        errorCount += Checkers.checker(
                "C: isAbsolute",
        ...
        // ------------------------------------------------------------
        // Mixed separator normalization (Windows accepts both)
        // ------------------------------------------------------------
        Path p7 = Paths.get("C:/a/b\\c");
        errorCount += Checkers.checker(
                "mixed separators root",
                "C:\\",
                rootToString(p7));

        errorCount += Checkers.checker(
                "mixed separators normalize",
                "C:\\a\\b\\c",
                p7.normalize().toString());
