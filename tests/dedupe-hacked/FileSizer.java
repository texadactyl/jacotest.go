...
public class FileSizer {
     ...
     */
    public void loadFileSizes( String dir, boolean nosubdirs, boolean quiet, LongStringListTable sizesTable ) {
        ArrayList<Path> files =
            new DirFileListMaker().go( FileSystems.getDefault().getPath( dir ), nosubdirs, quiet );
