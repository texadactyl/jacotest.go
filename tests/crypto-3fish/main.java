...
public class main {
    ...
    static long[] three_256_00_input = { 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L };

    static long[] three_256_00_tweak = { 0L, 0L };

    static long[] three_256_00_result = { 0x94EEEA8B1F2ADA84L, 0xADF103313EAE6670L,
            0x952419A1F4B16D53L, 0xD83F13E63C9F6B11L };

    static long[] three_256_01_key = { 0x1716151413121110L, 0x1F1E1D1C1B1A1918L,
            0x2726252423222120L, 0x2F2E2D2C2B2A2928L };

    static long[] three_256_01_input = { 0xF8F9FAFBFCFDFEFFL, 0xF0F1F2F3F4F5F6F7L,
            0xE8E9EAEBECEDEEEFL, 0xE0E1E2E3E4E5E6E7L };

    static long[] three_256_01_result = { 0x277610F5036C2E1FL, 0x25FB2ADD1267773EL,
            0x9E1D67B3E4B06872L, 0x3F76BC7651B39682L };

    static long[] three_256_01_tweak = { 0x0706050403020100L, 0x0F0E0D0C0B0A0908L };

    static long[] three_512_00_key = { 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
            0L, 0L, 0L, 0L };

    static long[] three_512_00_input = { 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
            0L, 0L, 0L, 0L, 0L };

    static long[] three_512_00_tweak = { 0L, 0L };

    static long[] three_512_00_result = { 0xBC2560EFC6BBA2B1L, 0xE3361F162238EB40L,
            0xFB8631EE0ABBD175L, 0x7B9479D4C5479ED1L, 0xCFF0356E58F8C27BL,
            0xB1B7B08430F0E7F7L, 0xE9A380A56139ABF1L, 0xBE7B6D4AA11EB47EL };

    static long[] three_512_01_key = { 0x1716151413121110L, 0x1F1E1D1C1B1A1918L,
            0x2726252423222120L, 0x2F2E2D2C2B2A2928L, 0x3736353433323130L,
            0x3F3E3D3C3B3A3938L, 0x4746454443424140L, 0x4F4E4D4C4B4A4948L };

    static long[] three_512_01_input = { 0xF8F9FAFBFCFDFEFFL, 0xF0F1F2F3F4F5F6F7L,
            0xE8E9EAEBECEDEEEFL, 0xE0E1E2E3E4E5E6E7L, 0xD8D9DADBDCDDDEDFL,
            0xD0D1D2D3D4D5D6D7L, 0xC8C9CACBCCCDCECFL, 0xC0C1C2C3C4C5C6C7L };

    static long[] three_512_01_tweak = { 0x0706050403020100L, 0x0F0E0D0C0B0A0908L };

    static long[] three_512_01_result = { 0xD4A32EDD6ABEFA1CL, 0x6AD5C4252C3FF743L,
            0x35AC875BE2DED68CL, 0x99A6C774EA5CD06CL, 0xDCEC9C4251D7F4F8L,
            0xF5761BCB3EF592AFL, 0xFCABCB6A3212DF60L, 0xFD6EDE9FF9A2E14EL };

    static long[] three_1024_00_key = { 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
            0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
            0L, 0L, 0L, 0L };

    static long[] three_1024_00_input = { 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
            0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
            0L, 0L, 0L, 0L };

    static long[] three_1024_00_tweak = { 0L, 0L };

    static long[] three_1024_00_result = { 0x04B3053D0A3D5CF0L, 0x0136E0D1C7DD85F7L,
    ...
    static long[] three_1024_01_key = { 0x1716151413121110L, 0x1F1E1D1C1B1A1918L,
            0x2726252423222120L, 0x2F2E2D2C2B2A2928L, 0x3736353433323130L,
            0x3F3E3D3C3B3A3938L, 0x4746454443424140L, 0x4F4E4D4C4B4A4948L,
    ...
    static long[] three_1024_01_input = { 0xF8F9FAFBFCFDFEFFL, 0xF0F1F2F3F4F5F6F7L,
            0xE8E9EAEBECEDEEEFL, 0xE0E1E2E3E4E5E6E7L, 0xD8D9DADBDCDDDEDFL,
            0xD0D1D2D3D4D5D6D7L, 0xC8C9CACBCCCDCECFL, 0xC0C1C2C3C4C5C6C7L,
    ...
    static long[] three_1024_01_tweak = { 0x0706050403020100L, 0x0F0E0D0C0B0A0908L };

    static long[] three_1024_01_result = { 0x483AC62C27B09B59L, 0x4CB85AA9E48221AAL,
    ...
    static boolean basicTest256() {
        ...
        if (!Arrays.areEqual(dataIn, result)) {
            hexdump("basicTest256: Decrypt failed 256 00", result, result.length);
            return false;
        }
        // Next Vector
        ...
        if (!Arrays.areEqual(result, dataOut)) {
            hexdump("basicTest256: Wrong cipher text 256 01", dataOut, dataOut.length);
            return false;
        }
        // Decrypt and check
        ...
        tfc.processBlock(dataOut, 0, result, 0);
        if (!Arrays.areEqual(dataIn, result)) {
            hexdump("basicTest256: Decrypt failed 256 01", result, result.length);
            return false;
        }
        System.out.println("basicTest256: Success!");
        return true;
    }

    static boolean basicTest512() {
        ...
        if (!Arrays.areEqual(result, dataOut)) {
            hexdump("basicTest512: Wrong cipher text 512 00", dataOut, dataOut.length);
            return false;
        }
        // Decrypt and check
        tfc.init(false, pft);
        tfc.processBlock(dataOut, 0, result, 0);
        if (!Arrays.areEqual(dataIn, result)) {
            hexdump("basicTest512: Decrypt failed 512 00", result, result.length);
            return false;
        }
        // Next vector
        ...
        if (!Arrays.areEqual(result, dataOut)) {
            hexdump("basicTest512: Wrong cipher text 512 01", dataOut, dataOut.length);
            return false;
        }
        // Decrypt and check
        // plaintext feed backward :-)
        ...
        tfc.processBlock(dataOut, 0, result, 0);
        if (!Arrays.areEqual(dataIn, result)) {
            hexdump("basicTest512: Decrypt failed 512 01", result, result.length);
            return false;
        }
        System.out.println("basicTest512: Success!");
        return true;
    }

    static boolean basicTest1024() {
        ...
        if (!Arrays.areEqual(result, dataOut)) {
            hexdump("basicTest1024: Wrong cipher text 1024 00", dataOut, dataOut.length);
            return false;
        }
        // Decrypt and check
        tfc.init(false, pft);
        tfc.processBlock(dataOut, 0, result, 0);
        if (!Arrays.areEqual(dataIn, result)) {
            hexdump("basicTest1024: Decrypt failed 1024 00", result, result.length);
            return false;
        }
        // Next vector
        ...
        if (!Arrays.areEqual(result, dataOut)) {
            hexdump("basicTest1024: Wrong cipher text 1024 01", dataOut, dataOut.length);
            return false;
        }
        // Decrypt and check
        // plaintext feed backward :-)
        ...
        tfc.processBlock(dataOut, 0, result, 0);
        if (!Arrays.areEqual(dataIn, result)) {
            hexdump("basicTest1024: Decrypt failed 1024 01", result, result.length);
            return false;
        }
        System.out.println("basicTest1024: Success!");
        return true;
    }
