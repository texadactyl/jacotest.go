...
public class main {
    ...
    public static int runner() {
        System.out.println("runner: Testing the use of Calculator1 and Calculator2 from different jar files");
        int result1 = -1;
        int result2 = -1;
        Calculator1 obj1;
        Calculator2 obj2;
    ...
    public static void main(String args[]) {
        ...
        execCommand("jar --create --verbose --file=jar2.jar middle/calculator2/Calculator2.class");        
		System.out.println("\n======================================= main: Show the jar2 table of contents");
        execCommand("jar tf jar2.jar");
