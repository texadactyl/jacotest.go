...
public class main {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        osw.write(chArray, 0, N_ELEMENTS);
        osw.close();
    	...
    	fos = new FileOutputStream(FilePath);
    	osw = new OutputStreamWriter(fos);
        osw.write(chArray, offset, length);
        osw.close();
        ...
        // Whole string
        String str1 = "Mary had a little lambe whose fleece was white as snow.";
        int strlen =  str1.length();
        fos = new FileOutputStream(FilePath);
    	osw = new OutputStreamWriter(fos);
		osw.write(str1, 0, strlen);
		osw.close();
