public class ProcInteger {
    ...
    public static int procInteger() {
        ...
        if(ii == 15)
            { System.out.print("Success: Unboxed Integer = "); System.out.println(ii); }
        else {
            errorCount += 1;
            System.out.print("FAILED: Unboxed Integer not = 15, observed = "); System.out.println(ii); 
        }
        ...
        if(bite == 0x05)
            ...
            errorCount += 1;
            System.out.print("FAILED: II.byteValue() = 0x05, observed = "); System.out.println(bite); 
        }
        ...
        if(cc == 0)
            ...
            errorCount += 1;
            System.out.print("FAILED: II.compareTo(II_DITTO)==0, observed = "); System.out.println(cc); 
        }
        ...
        if(cc == 1)
            ...
            errorCount += 1;
            System.out.print("FAILED: II.compareTo(II_SMALLER)==1, observed = "); System.out.println(cc); 
        }
        ...
        if(cc < 0)
            ...
            errorCount += 1;
            System.out.print("FAILED: II.compareTo(II_LARGER)==-1, observed = "); System.out.println(cc); 
        }
        ...
        if(ss.equals("5"))
            ...
            errorCount += 1;
            System.out.print("FAILED: II.toString() = 5, observed = "); System.out.println(ss); 
        }
