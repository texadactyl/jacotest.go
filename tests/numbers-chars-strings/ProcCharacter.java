public class ProcCharacter {
    ...
    public static int procCharacter() {
        ...
        if( aa == 'a' )
            ...
            errorCount += 1;
            System.out.print("FAILED: Lower case of AA is 'a', observed: "); System.out.println(aa);
        }
        ...
        if( ss.equals("A") )
            ...
            errorCount += 1;
            System.out.print("FAILED: Character.String(AA) is \"a\", observed: "); System.out.println(ss);
        }
