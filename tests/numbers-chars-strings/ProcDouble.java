public class ProcDouble {
    ...
    public static int procDouble() {
        ...
        dd = dd + 10.0;
        if(dd == 15.0)
            { System.out.print("Success: Unboxed Double = "); System.out.println(dd); }
        else {
            errorCount += 1;
            System.out.print("FAILED: Unboxed Double not = 15, observed = "); System.out.println(dd); 
        }
        ...
        if(bite == 0x05)
            ...
            errorCount += 1;
            System.out.print("FAILED: DD.byteValue() = 0x05, observed = "); System.out.println(bite); 
        }
        ...
        if(cc == 0)
            ...
            errorCount += 1;
            System.out.print("FAILED: DD.compareTo(DD_DITTO)==0, observed = "); System.out.println(cc); 
        }
        ...
        if(cc == 1)
            ...
            errorCount += 1;
            System.out.print("FAILED: DD.compareTo(DD_SMALLER)==1, observed = "); System.out.println(cc); 
        }
        ...
        if(cc < 0)
            ...
            errorCount += 1;
            System.out.print("FAILED: DD.compareTo(DD_LARGER)==-1, observed = "); System.out.println(cc); 
        }
        ...
        if(ss.equals("5.0"))
            ...
            errorCount += 1;
            System.out.print("FAILED: DD.toString() = 5, observed = "); System.out.println(ss); 
        }
