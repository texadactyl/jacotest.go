...
public class main {
    ...
    public static void main(String args[]) {
        ...
        execCommand("jar --create --verbose --main-class=main --file=MyLib.jar Calculator.class");
        
		System.out.println("\n======================================= main: Show the jar table of contents");
        execCommand("jar tf MyLib.jar");
        
        System.out.println("\n======================================= main: Launch JVM to call function runner");
        String cp = System.getProperty("java.class.path");
        String cpSep = System.getProperty("path.separator");
        System.out.printf("path.separator = %s\n", cpSep);
        String text = String.format("%s -cp MyLib.jar%s%s main RUNNER", jvmPgmName, cpSep, cp);
        execCommand(text);
