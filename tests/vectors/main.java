...
public class main {
	...
	public static void main(String[] args) throws Exception {
        ...
        Vector<Integer> vint = new Vector<>(Arrays.asList(vintIntegers));
        System.out.println("Vector vint(3): " + vint);
        System.out.println("Vector vint: " + vint);
        System.out.println("Vector vint capacity: " + vint.capacity());
        ...
        vint.add(7);
        vint.add(8);
        System.out.println("Vector vint(8): " + vint);
        ...
        sum = vint.stream().reduce(Integer::sum).get();
        System.out.println("Vector vint element sum after removing one element: " + sum);
